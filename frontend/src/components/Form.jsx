...
const FormUI = () => {
  const {saveData, nama, alamat, npm, gender, setNama, setAlamat, setNpm, setGender} =  useAddData();
  return (
    <div className='  w-96  p-4 rounded'>
      <h1 className="text-lg mb-1">Masukkan Data</h1>
      <form action="http://localhost:3000/users" className='form flex flex-col gap-3' onSubmit={saveData} >
